    ...
    >
      <div className="max-w-[480px] text-center md:text-left">
        ...
        <p className="mb-7 leading-relaxed text-muted">
          ...
          frameworks and deployment strategies to ensure every project I touch
          is modern and secure. Whether I am optimizing database queries or
          refining a responsive UI, my goal is always to build scalable,
          production-ready software that meets the rigorous demands of today's
          digital landscape.
        </p>
      ...
      <div className="relative h-52 w-52 flex-shrink-0 sm:h-64 sm:w-64 md:h-72 md:w-72">
        ...
        <img
          src="/whatsApp/IMG_20230930_174059.jpg"
          alt="Portrait"
